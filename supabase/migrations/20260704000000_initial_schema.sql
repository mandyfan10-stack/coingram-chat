-- Historical bootstrap captured before the first incremental migration.
-- Keep changes after this point in timestamped migrations; do not edit deployed history.
